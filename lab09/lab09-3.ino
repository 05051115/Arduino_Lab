...
LBLEService ledService("05051115-E8F2-537E-4F6C-D104768A1214");
LBLECharacteristicInt switchCharacteristic("05051115-E8F2-537E-4F6C-D104768A1214", LBLE_READ | LBLE_WRITE);
...
void setup() {
  ...
  advertisement.configAsConnectableDevice("余采潔");

  // Configure our device's Generic Access Profile's device name
  // Ususally this is the same as the name in the advertisement data.
  LBLEPeripheral.setName("余采潔");
